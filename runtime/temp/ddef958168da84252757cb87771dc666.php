<?php /*a:1:{s:59:"C:\wamp\www\mall\application\admin\view\rbac\edit_role.html";i:1576138510;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
        ...
        <form action="<?php echo url('Rbac/editRole'); ?>" method="post" class="form form-horizontal">
            <div class="Operate_cont clearfix">
                ...
                <div class="formControls ">
                    <input type="text" class="input-text" value="<?php echo htmlentities($editdata['name']); ?>" placeholder=""  name="name" datatype="*" nullmsg="角色英文名称不能为空！">
            ...
            <div class="Operate_cont clearfix">
                ...
                <div class="formControls ">
                    <input type="text" class="input-text" value="<?php echo htmlentities($editdata['remark']); ?>" placeholder=""  name="remark" datatype="*" nullmsg="角色描述不能为空！">
                    <span class="Validform_checktip"></span>
                </div>
            </div>
            <div class="Operate_cont clearfix">
                ...
                <div class="formControls form-inline">
                    <label for="">
                        <input type="radio" name="status" value="1" <?php if($editdata['status'] == 1): ?>checked<?php endif; ?>>是
                    </label>
                    <label for="">
                        <input type="radio" name="status" value="0" <?php if($editdata['status'] == 0): ?>checked<?php endif; ?>>否
                    </label>
                </div>
            </div>        
            <div class="Operate_cont clearfix">
