<?php /*a:1:{s:55:"C:\wamp\www\mall\application\admin\view\rbac\index.html";i:1574922824;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
        ...
        <form action="" method="post" class="form form-horizontal">
            <div class="Operate_cont clearfix">
                ...
                <div class="formControls ">
                    <input type="text" class="input-text" value="" placeholder=""  name="name" datatype="*" nullmsg="分类名称不能为空！">
            ...
            <div class="Operate_cont clearfix">
                ...
                <div class="formControls ">
                    <input type="text" class="input-text" value="" placeholder=""  name="sort" datatype="*" nullmsg="排序不能为空！">
                    <span class="Validform_checktip"></span>
                </div>
            </div>
            <div class="Operate_cont clearfix">
